...
const emit = defineEmits<{
  ...
  /// select a result or fall through to send: a menu with pending or
  /// non-empty results is "active" and defers Enter; a settled empty
  /// result set lets Enter send the raw `@query` text.
