...
const rpc = BrowserView.defineRPC<DafmanRPC>({
	...
	handlers: {
		requests: {
			...
			searchWorkspaceFiles: rpcGuard(async ({ sessionId, query, limit, includeHidden, includeIgnored }) =>
