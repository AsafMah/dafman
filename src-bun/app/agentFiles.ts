...
/// names, etc.).
function resolveTargetPath(scope: AgentScope, name: string, workingDirectory?: string): { path: string; root: string } {
...
export async function deleteAgent(scope: AgentScope, name: string, workingDirectory?: string): Promise<boolean> {
