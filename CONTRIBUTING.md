...
## Where to start
- Read [`plans/DONE.md`](plans/DONE.md) for what Dafman ships today.
- Read [`plans/TODO.md`](plans/TODO.md) for what's open and prioritized.
...
- Add or update tests for new behavior - see Testing instructions in [`AGENTS.md`](AGENTS.md).
## Code style
...
- See [`ARCHITECTURE.md`](ARCHITECTURE.md) for current module map and invariants.
